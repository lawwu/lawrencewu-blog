...
[Workflowy](https://workflowy.com/): A simple yet powerful app for note-taking, outlining, and task management, Workflowy helps you organize your thoughts and projects using nested lists and intuitive keyboard shortcuts. It's simple at it's core as Workflowy is essentially an infinitely nested bulleted list. They've added additional features over the years like mirroring lists which I've found helpful. Notion may have more features but I haven't overcome the inertia needed to switch yet.
