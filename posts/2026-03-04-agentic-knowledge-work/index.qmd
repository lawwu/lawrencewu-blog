...
author: Lawrence Wu
date: '2026-03-08'
categories: [ai, "claude code", agents, "agentic harness", codex]
---
...
I've had the opportunity to observe this transition first hand. I was a heavy LangChain and LangGraph user since that project started in 2024 and continued a heavy user in 2025 (I [attended their first conference](https://lawrencewu.net/posts/2025-05-30-langchain-interrupt-lwu-recap/) in early 2025). But Claude Code is a different beast. It's a complete different type of agentic harness. The reason it is different are a few:
...
Since I [started using Claude Code regularly in July 2025](https://lawrencewu.net/posts/2025-07-18-starting-to-use-claude-code/), I've noticed a few things in my day-to-day job as a data scientist and data science manager:
...
- I started capturing examples of agentic knowledge work: [lawwu/awesome-agentic-knowledge-work](https://github.com/lawwu/awesome-agentic-knowledge-work).
