...
author: Lawrence Wu
date: '2026-02-10'
categories: [ai, "claude code", "agentic harness"]
---

As a daily Claude Code user for [the last 6 months](https://lawrencewu.net/posts/2025-07-18-starting-to-use-claude-code/), I've learned a lot about Claude Code and agentic coding in general. Trying this thing where I share 1 thing per day. I'm posting on LinkedIn but I'll update this post with each tip.
...
I also saw Anthropic has an official CLAUDE.md management plugin that has a skill for automating this too [here](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/claude-md-management). Reading about their plugins is very inspirational on what is possible now: <https://github.com/anthropics/claude-plugins-official>.
...
[Posted on 2026-02-13](https://www.linkedin.com/posts/lawrencewu920_day-4-of-my-claude-code-daily-tips-series-activity-7428098173602185216-EhKW?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
[Posted on 2026-02-16](https://www.linkedin.com/posts/lawrencewu920_claudecode-activity-7429185326138531840-bepC?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)

- Claude Code stores logs at: `~/.claude/projects/`
- Only keeps 30 days by default
- Tip: Add `"cleanupPeriodDays": 99999` to `~/.claude/settings.json` to preserve this valuable data
...
[Posted on 2026-02-17](https://www.linkedin.com/posts/lawrencewu920_claudecode-activity-7429551565948166147-ypB0?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)

![](./images/cc_day6_plan_mode.png)
...
[Posted on 2026-02-18](https://www.linkedin.com/posts/lawrencewu920_skills-vs-dynamic-mcp-loadouts-activity-7429910264294084608-TZkO?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
[Posted on 2026-02-19](https://www.linkedin.com/posts/lawrencewu920_customize-your-status-line-claude-code-activity-7430272648762413056-QELx?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
[Posted on 2026-02-20](https://www.linkedin.com/posts/lawrencewu920_benefits-of-an-llm-gateway-i-think-one-of-activity-7430635093079007232-3IIN?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
[Posted on 2026-02-23](https://www.linkedin.com/posts/lawrencewu920_remember-there-is-a-difference-between-claude-activity-7431722215802535936-IzQ1?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
The Claude Code CLI changes rapidly — see the [CHANGELOG](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md). Each version bumps the harness, not the underlying model. The harness handles: tool orchestration, context management, permissions, memory, prompt caching. There are system prompts embedded in the harness too.

Why does this matter? When Claude Code "gets better" it could be either the model OR the harness improving.

Boris Cherny in this [interview](https://www.youtube.com/watch?v=We7BZVKbCVw) talked about how he stuck with the terminal UI because he wanted to make as thin of a harness as possible so that improvements in model capability could be passed to the user. Claude Code recently turned 1 year old. It has gotten more feature rich. There has been an interesting project called Pi that I heard about because it's the agent framework powering OpenClaw. Armin Ronacher writes about it [here](https://lucumr.pocoo.org/2026/1/31/pi/).

## Day 11 — Terminal vs VS Code Extension

[Posted on 2026-02-24](https://www.linkedin.com/posts/lawrencewu920_claude-code-started-with-a-tui-terminal-activity-7432084570629402624-bJBl?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
[Posted on 2026-02-25](https://www.linkedin.com/posts/lawrencewu920_github-peonpingpeon-ping-warcraft-iii-activity-7432447018251374592-RH87?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)

![](./images/cc_day12_peonping.png)

I've really enjoyed using [Peon Ping](https://github.com/PeonPing/peon-ping) for the last few weeks. It adds a Claude Code hook at the beginning and end of each session. It notifies you with a system notification and a custom sound. The default is a Warcraft III peon. There's also sounds from Starcaft and Age of Empires and a bunch of other goodies. The sounds are fun but it's genuinly useful knowing when the agent finishes it's task.
...
[Posted on 2026-02-26](https://www.linkedin.com/posts/lawrencewu920_you-can-run-claude-code-in-your-github-actions-activity-7432809363100061697-VpWz?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
I've used this Github Action to mainly review PRs but also generate commits and PRs. I was inspired to set this up when I saw the Anthropic team close [an issue I opened](https://github.com/anthropics/claude-code-action/issues/756) by just tagging "@claude can you fix it" and passing a link. Amazing.
...
[Posted on 2026-02-27](https://www.linkedin.com/posts/lawrencewu920_dont-allow-the-agent-to-outpace-your-understanding-activity-7433171647173640192-mlk0?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)
...
[Posted On 2026-03-02](https://www.linkedin.com/posts/lawrencewu920_we-build-our-entire-harness-around-prompt-activity-7434258928865157120-Ohmh?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAE5gYIBXATpK1K66bvyVE0Gc0prVDW-82g)

![](./images/cc_day15_prompt_caching.png)
...
1. System Prompt & Tools (global cache)
2. CLAUDE.md (cached within a porject)
