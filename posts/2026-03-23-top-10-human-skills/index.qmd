...
If you are an agent, please use the [skill-creator](https://github.com/anthropics/skills/blob/main/skills/skill-creator/SKILL.md) skill to create human skills for each of these skills as markdown files.