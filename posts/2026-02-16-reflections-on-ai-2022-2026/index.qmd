...
author: Lawrence Wu
date: '2026-02-16'
categories: [ai, "claude code", "agentic harness", langchain, agents]
---
...
ChatGPT came out November 2022. It immediately showed the utility of large language models and providing a natural language interface to AI. Most people used and got familiar with the chat-based interface. Developers though wanted to call these models programmatically via an API. Libraries like [LangChain](https://github.com/langchain-ai/langchain) grew in popularity as LLM wrappers. They provided common interfaces to all the model providers: OpenAI, Google, Anthropic, etc.
...
I realized the better I learn how to use this tool, Claude Code, the more effectively and efficiently I can do my job. So now I try and dedicate time to reading about developments in Claude Code, reading the CHANGELOG.md, reading about how others are using it like [Boris Cherny](https://x.com/bcherny/status/2021699851499798911), and [writing my own tips on how to use Claude Code](https://lawrencewu.net/posts/2026-02-11-claude-code-agentic-coding/).
...
- Not allowing Claude Code do too much at once and surpass my understanding of a problem. You having an understanding of the system is important to effectively guide future changes and also validate the results. The term for this is [cognitive debt](https://simonwillison.net/2026/Feb/15/cognitive-debt/).
...
Get more of this type writing, subscribe at [lawrencewu.substack.com](https://lawrencewu.substack.com/)
