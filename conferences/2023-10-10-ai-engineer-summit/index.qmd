...
author: "Lawrence Wu"
date: "2023-10-10"
categories: [conference, ai, llms, agents, rag]
---
...
- Review his nextJS architecture for some of his apps
...
- How does he keep these apps free?
  ...
  - Make it look visually appealing - spend 80% of time on UI
...
- Ways to improve RAG applications in the wild
  - Human Feedback: support improvements using human feedback
...
- Start with the easy stuff first: Table Stakes
- Table Stakes:
  - Chunk Sizes
...
- How do I prevent LLM hallucinations?
  - Provenance Guardrails: every LLM utterance should be grounded in a truth
