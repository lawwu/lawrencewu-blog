...
Note, I don't always watch a YouTube video in full. It's easy to transcribe videos now ever since [Whisper](https://lawrencewu.net/posts/2023-11-15-whisper-transcripts/) came out. I transcribe some YouTube channels [here](https://lawwu.github.io/transcripts/), see the project called [transcripts](https://github.com/lawwu/transcripts). I'll also use [yt-dlp](https://github.com/yt-dlp/yt-dlp) to download videos and transcribe them with [MacWhisper](https://goodsnooze.gumroad.com/l/macwhisper).
...
- [DeepLearning.ai](https://www.deeplearning.ai/courses/) - very good short courses
- [Trending Papers](https://huggingface.co/papers/trending) - Huggingface purchased paperswithcode.com so that redirects here now.
- [Large Language Models Explained](https://www.understandingai.org/p/large-language-models-explained-with) - Timothy Lee (journalist) spends a couple months writing up this explainer of LLMs
